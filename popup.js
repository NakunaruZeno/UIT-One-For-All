/**
 * ============================================================
 * UIT One For All — Popup Script
 * ============================================================
 * Xử lý giao diện popup khi nhấn icon extension:
 *  - Mã hóa mật khẩu AES-GCM 256-bit
 *  - Lưu/tải cấu hình tài khoản & chu kỳ đồng bộ
 *  - Nút đồng bộ thủ công & mở Dashboard
 * ============================================================
 */
...
// Chuyển đổi ArrayBuffer sang chuỗi Base64
...
// Lấy hoặc tạo mới khóa AES-GCM 256-bit (lưu dạng JWK trong storage)
...
// Mã hóa mật khẩu bằng AES-GCM 256-bit, trả về { cipher, iv } dạng Base64
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Nạp dữ liệu cấu hình đã lưu (không hiển thị mật khẩu ra ngoài)
  ...
  // Nút LƯU: Lưu tài khoản & cấu hình đồng bộ
  saveBtn.addEventListener('click', async () => {
    ...
    if (u) {
      ...
      if (p) {
        ...
        // Xóa mật khẩu Base64 cũ (phiên bản trước)
  ...
  // Nút ĐỒNG BỘ: Kích hoạt đồng bộ thủ công
  ...
  // Nút mở Dashboard trong tab mới
